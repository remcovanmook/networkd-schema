...
<body>
    <div class="container">
        ...
        <div class="hero">
            ...
            <a href="{latest_ver}/systemd.network.schema.json" class="btn">View Latest Network Schema</a>
        </div>
...
"""
    ...
    with open(os.path.join(schemas_dir, "index.html"), "w") as f:
        f.write(html)
    print(f"Generated schemas index at {os.path.join(schemas_dir, 'index.html')}")
...
<body>
    <div class="container">
        ...
        <div class="hero">
            ...
            <p>Comprehensive reference manuals for systemd version <strong>{latest_ver}</strong>.</p>
        ...
        <div style="text-align: center; margin-bottom: 50px;">
            ...
            <a href="schemas/" class="btn" style="background: #1f6feb;">Browse Schemas</a>
        </div>
