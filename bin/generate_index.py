...
<body>
    <div class="container">
        ...
        <p style="text-align: center; font-size: 1.2em; color: #8b949e; margin-bottom: 40px;">
            ...
            <br>
            <span style="background: #238636; color: white; padding: 2px 8px; border-radius: 4px; font-size: 0.8em; vertical-align: middle; margin-top: 10px; display: inline-block;">Schema Version: Draft-07</span>
        </p>
